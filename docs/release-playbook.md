...
1.  Trigger a new pipeline in BuildKite to test the release candidate with all the downstream projects.
    ...
    * **Note:** Before any release, always make sure the downstream builds for the release candidate should not have any extra breakages and also all the    Bazel jobs should green.
